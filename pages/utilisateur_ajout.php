    ...
    <body>  
        ...
        <div class="container page">
            ...
            <div class="row center">
                <!-- Titre de la page -->
                <h1 class="center" id="titre">Ajouter un utilisateur</h1>
            </div>
            ...
            <div class="row center borderForm">
                ...
                <form method="post" class="col s12 formulaire" id="infosPerso" action="<?php echo $_SERVER['PHP_SELF']?>">
                    ...
                    <br/>
                    <h2 id="h2"><center>Veuillez saisir les informations du nouvel utilisateur puis les valider.<center></h2>
                    <br/>
                    <!-- ligne 1 -->
                    ...
                    <?php
                        if(!empty($_POST['nom']) && !empty($_POST['prenom']) && !empty($_POST['email']) && !empty($_POST['mdp'])) {
                            ...
                            $res = ajoutUtil($_POST['nom'],$_POST['prenom'],$_POST['email'],$_POST['mdp']);
                            
                            if($res) {
                                echo "Ajout effectué";
                            } else {
                                echo "Erreur : impossible d'ajouter ".$nom." ".$prenom." ";
                            }
                        }
                    ?>
