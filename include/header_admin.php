...
<nav>
	...
	<div class="nav-wrapper blue lighten-3">
		...
		<ul class="right hide-on-med-and-down 10px">
            ...
            <li><a href="planning_accueil.php"><i class="material-icons right">assignment</i>Gérer planning</a class="taille"></li>
            <li><a href="equipe_accueil.php"><i class="material-icons right">assignment_ind</i>Gérer équipes</a></li>
			<li><a href="utilisateur_accueil.php"><i class="material-icons right">assignment_ind</i>Gérer utilisateurs</a></li>
			<li><a href="ajoutFichier.php"><i class="material-icons right">file_upload</i>Importer fichier</a></li>
		...
		<ul class="side-nav" id="mobile-demo">
            ...
            <li><a href="planning_accueil.php"><i class="material-icons right">add_circle</i>Gérer planning</a class="taille"></li>
            <li><a href="equipe_accueil.php"><i class="material-icons right">assignment_ind</i>Gérer équipes</a></li>
			<li><a href="utilisateur_accueil.php"><i class="material-icons right">assignment_ind</i>Gérer utilisateurs</a></li>
			<li><a href="ajoutFichier.php"><i class="material-icons left">file_upload</i>Importer fichier</a></li>
